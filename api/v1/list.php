<?php
	...
	function get_jpv_html($list, $error_info) {		
		...
		foreach($list as $song_data) {
			...
			$html = "$html<div class='song-box'><div class='song-image' data-toggle='tooltip' title='$album'><img src='./api/v1/art.php?file=$filename'></img></div><div class='song-info'><div class='song-title'>$title</div><br /><div class='song-artist' data-toggle='tooltip' title='$albumartist'>$artist</div><br /><div class='song-length'>$length</div><br /><div class='song-buttons'><div class='song-button song-play-button glyphicon glyphicon-play-circle'></div><a href='./media/$filename' target='_blank' data-toggle='tooltip' title='You may need to right click, Save As...'><div class='song-button song-download-button glyphicon glyphicon-download'></div></a></div></div></div>";
		}
