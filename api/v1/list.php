<?php
	...
	function get_jpv_html($list, $error_info) {		
		if($list == null) {
			...
			header('Content-Type: application/json');
			return '{"status":"500", "message":"<div class=\'song-box error-box\'><div class=\'song-image\'><img src=\"./img/error.jpg\"></img></div><div class=\'song-info\'><div class=\'song-title\'>Internal Server Error</div><br /><div class=\'song-length error-subtitle\'>Song list is null (' . $error_info . ')</div></div></div>"}';
		}
